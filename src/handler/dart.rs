...
pub async fn handle_dart_message(context: &Context, message: &Message) -> Result<bool> {
...
pub async fn handle_dart_command(context: &Context, command: &Command) -> Result<bool> {
