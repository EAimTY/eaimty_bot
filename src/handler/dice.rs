...
pub async fn handle_dice_message(context: &Context, message: &Message) -> Result<bool> {
...
pub async fn handle_dice_command(context: &Context, command: &Command) -> Result<bool> {
